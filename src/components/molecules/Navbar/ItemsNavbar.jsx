...
const ItemsNavbar = ({ visiblite }) => {
  ...
  const items = [
    ...
    },
    {
      ...
      icon: <GoFileDirectoryFill className="w-5 h-5" />, 
      link: "/documentos",
    },
    {
    ...
    },
    {
      ...
      icon: <BsHousesFill className="w-5 h-5" />, 
      link: "/ambientes",
    },
    {
    ...
    },
    {
      ...
      icon: <BiSolidCoffeeBean className="w-5 h-5" />, 
    },
    {
    ...
    },
    {
      ...
      icon: <BsFillFileBarGraphFill className="w-5 h-5" />, 
    },
    {
